            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 text-center text-lg-start">
                        <a href="?a=home" class="p-0 m-0"><img src="img/logo/Logo.png" alt="logo"></a>
                    </div>
                    <div class="col-lg-5 text-center my-3 my-sm-0">
                        <div class="copyright-text">
                            <p>Copyright&copy; Banca 2023. <br class="d-sm-none"> <a class="ms-2" href="#">Privecy</a> |
...
<!-- Mirrored from html-template.spider-themes.net/banca/index-loan.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Feb 2025 14:36:27 GMT -->
</html>